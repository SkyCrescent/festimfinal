            ...
            <div className="relative w-full h-[84%] ">
               ...
               <div className="relative h-auto  w-[90%] mx-auto md:mx-6 mt-28 space-y-12   ">
                  <div className="relative  h-auto   ">
                     <div
                        className="bg-red-900 relative bg-cover   bg-[url('../public/111222t.png')] h-[80%] mx-4 w-[93%] md:w-[50%]  rounded-tr-full justify-center  ">
                  ...
                  <div className="relative  h-auto   ">
                     ...
                     <div
                        className="bg-red-900 relative bg-cover   bg-[url('../public/111222t.png')] h-[90%] md:h-[80%] md:mx-4 p-1 md:p-0  w-[100%]  md:w-[100%] lg:w-[60%]  rounded-tr-full justify-center  ">
               ...
               <div className="relative h-auto  w-[90%] mx-auto md:mx-6 mt-20 space-y-12   ">
                  ...
                  <div className="relative  h-auto   ">
                     <div
                        className="bg-red-900 relative bg-cover   bg-[url('../public/111222t.png')] h-[88%] md:h-[90%] mx-4 w-[93%] md:w-[80%] lg:w-[65%]  rounded-tr-full justify-center  ">
                  ...
                  <div className="relative  h-auto   ">
                     <div
                        className="bg-red-900 relative bg-cover   bg-[url('../public/111222t.png')] h-[88%] md:h-16 lg:h-10 mx-4 w-[93%] md:w-[98%] lg:w-[88%]  rounded-tr-full justify-center  ">
                  ...
                  <div className="relative  h-auto   ">
                     <div
                        className="bg-red-900 relative bg-cover   bg-[url('../public/111222t.png')] h-[88%] md:h-12 lg:h-10 mx-4 w-[100%] md:w-[98%] lg:w-[88%]  rounded-tr-full justify-center  ">
