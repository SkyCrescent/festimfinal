...
import regle from '@/public/img/11395658.jpg'
import instructions from '@/public/img/50441540.jpg'
import inscription from '@/public/img/inscription.jpg'
import reunion from '@/public/img/réunion.jpg'
import plagat from '@/public/img/5687-risques-et-sanctions.png'
import getty from '@/public/img/getty.jpg'
import getty2 from '@/public/img/1677447587754.jpg'
import faire from '@/public/img/faire.png'
import pasfaire from '@/public/img/55ed9b.gif'
               ...
               <div className="relative w-[100%]  lg:w-[95%] h-auto   lg:flex lg:flex-row ">
                  <div className="relative w-[98%] mx-1 md:mx-8  md:w-[90%] lg:w-[40%] leading-4 ">
                     ...
                     <div className="mt-10 ">
                        ...
                        <div
                           className="bg-red-900 bg-cover   bg-[url('../public/111222t.png')] h-8 w-80 rounded-tr-full justify-center">
