...
export default function AddEvent({modal, SetModal}){
   ...
   const input = [
      ...
      { id: 3, name: "dateD",type: "date",minDate : "2024-02-10",value: values.dateD  ,maxDate : "2028-12-10", placeholder: "Debut de l'evenement", label: "Debut de l'evenement", className: "text-large relative w-[95%] text-gray-700 border rounded-[10px] border-gray-300 py-2 px-4 h-12 focus:outline-none focus:border-blue-500",
         error: values.dateD ? null : 'Quel jour votre evenement commence?' , img: `` },

      { id: 4, name: "dateF",type: "date",minDate : "2024-02-10",value: values.dateF  ,maxDate : "2028-12-10", placeholder: "birthday", label: "Fin de l'evenement", className: "text-large relative w-[95%] text-gray-700 border rounded-[10px] border-gray-300 py-2 px-4 h-12 focus:outline-none focus:border-blue-500",
